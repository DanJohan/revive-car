<?php
	...
	class WorkshopLTE extends CI_Controller {
		public function index(){
			redirect(base_url('workshop/auth'));
		}
		/* public function top_nav(){
			$this->load->view('workshop/adminlte/layout/top-nav');
		}
		public function boxed(){
			$this->load->view('workshop/adminlte/layout/boxed');
		}
		public function fixed(){
			$this->load->view('workshop/adminlte/layout/fixed');
		}
		public function collapsed_sidebar(){
			$this->load->view('workshop/adminlte/layout/collapsed-sidebar');
		}
		public function widgets(){
			$data['view'] = 'workshop/adminlte/widgets';
