        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-1">:</div>
                    <div class="col-xs-5"><?php echo $sequence['sequence']; ?></div>
                </div>
                <div class="row">
          ...
          <div class="col-xs-12">
              ...
              <div class="table-responsive">
                  <table class="table labour-table">
                    ...
                    <tr>
                          <td><input type="text" class="form-control" name="labour[0][item]" /></td>
                          <td><input type="number" class="form-control labour-hour" name="labour[0][hour]" /></td>
                          <td><input type="number" class="form-control labour-rate" name="labour[0][rate]" /></td>
                          <td><input type="number" class="form-control labour-cost" name="labour[0][cost]" readonly /></td>
                          <td><input type="number" class="form-control labour-gst" name="labour[0][gst]" /><input type="hidden" class="gst-amount" name="labour[0][gst_amount]" value="0.00"></td>
                          <td><input type="number" class="form-control labour-total" name="labour[0][total]" readonly /></td>
              ...
              <div class="table-responsive">
                  <table class="table parts-table">
                    <tr>
                      ...
                      <tr>
                          <td><input type="text" class="form-control" name="parts[0][item]" /></td>
                          <td><input type="number" class="form-control parts-qty" name="parts[0][qty]" /></td>
                          <td><input type="number" class="form-control parts-cost" name="parts[0][cost]" /></td>
                          <td><input type="number" class="form-control parts-gst" name="parts[0][gst]" /><input type="hidden" class="gst-amount" value="0.00" name="parts[0][gst_amount]"></td>
                          <td><input type="number" class="form-control parts-total" name="parts[0][total]" readonly /></td>
        ...
        <div class="row">
          ...
          <div class="col-xs-6">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-1">:</div>
                    <div class="col-xs-5"><input id="discount" type="text" name="discount" class="form-control" value="0"/></div>
                </div>
                <div class="row">
