   ...
   <div class="box">
    ...
    <div class="box-body">
        <table class="table">
            ...
            <!--<tr><td><a href="<?php echo base_url(); ?>workshop/enquiry/confirm/<?php //echo $enquiry['id']; ?>" class="btn btn-primary">Confirm</a></td></tr>-->
            
            <tr><td><a href="<?php echo base_url(); ?>workshop/enquiry/index" class="btn btn-primary bg-green ">Back</a></td></tr>
        </table>
    </div>
    <!-- /.box-body -->
  </div>
